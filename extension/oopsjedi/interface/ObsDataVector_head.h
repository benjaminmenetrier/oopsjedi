...
#ifndef OOPSJEDI_INTERFACE_OBSDATAVECTOR_HEAD_H_
#define OOPSJEDI_INTERFACE_OBSDATAVECTOR_HEAD_H_
...
class ObsDataVector : public utiljedi::Printable,
                      private utiljedi::ObjectCounter<ObsDataVector<OBS, DATATYPE> > {
  typedef typename OBS::template ObsDataVector<DATATYPE>  ObsDataVec_;

 public:
  static const std::string classname() {return "oopsjedi::ObsDataVector";}
...
#endif  // OOPSJEDI_INTERFACE_OBSDATAVECTOR_HEAD_H_
