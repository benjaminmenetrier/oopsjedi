...
#ifndef OOPSJEDI_INTERFACE_LINEAROBSOPERATOR_H_
#define OOPSJEDI_INTERFACE_LINEAROBSOPERATOR_H_
...
class LinearObsOperator : public utiljedi::Printable,
                          private boost::noncopyable,
                          private utiljedi::ObjectCounter<LinearObsOperator<OBS> > {
 ...
 public:
  ...
  static const std::string classname() {return "oopsjedi::LinearObsOperator";}
...
LinearObsOperator<OBS>::LinearObsOperator(const ObsSpace_ & os, const Parameters_ & parameters)
  : name_("oopsjedi::LinearObsOper::"+os.obsname()), oper_()
{
  Log::trace() << "LinearObsOperator<OBS>::LinearObsOperator starting" << std::endl;
  utiljedi::Timer timer(name_, "LinearObsOperator");
...
void LinearObsOperator<OBS>::setTrajectory(const GeoVaLs_ & gvals, const ObsAuxControl_ & aux) {
  ...
  utiljedi::Timer timer(name_, "setTrajectory");
...
void LinearObsOperator<OBS>::simulateObsTL(const GeoVaLs_ & gvals, ObsVector_ & yy,
  ...
  utiljedi::Timer timer(name_, "simulateObsTL");
...
void LinearObsOperator<OBS>::simulateObsAD(GeoVaLs_ & gvals, const ObsVector_ & yy,
  ...
  utiljedi::Timer timer(name_, "simulateObsAD");
...
#endif  // OOPSJEDI_INTERFACE_LINEAROBSOPERATOR_H_
