...
#ifndef OOPSJEDI_INTERFACE_ANALYTICINITBASE_H_
#define OOPSJEDI_INTERFACE_ANALYTICINITBASE_H_

#include "oopsjedi/generic/AnalyticInitBase.h"
...
class AnalyticInitBase : public oopsjedi::AnalyticInitBase<OBS> {
  typedef typename OBS::GeoVaLs          GeoVaLs_;
  typedef typename OBS::SampledLocations SampledLocations_;

 public:
  // Overrides of oopsjedi::AnalyticInit methods, converting between oops interface classes and
...
#endif  // OOPSJEDI_INTERFACE_ANALYTICINITBASE_H_
