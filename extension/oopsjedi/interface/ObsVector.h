...
#ifndef OOPSJEDI_INTERFACE_OBSVECTOR_H_
#define OOPSJEDI_INTERFACE_OBSVECTOR_H_
...
class ObsVector : public utiljedi::Printable,
                  private utiljedi::ObjectCounter<ObsVector<OBS> > {
  typedef typename OBS::ObsVector             ObsVector_;

 public:
  static const std::string classname() {return "oopsjedi::ObsVector";}
...
ObsVector<OBS>::ObsVector(const ObsSpace<OBS> & os, const std::string name) : data_() {
  ...
  utiljedi::Timer timer(classname(), "ObsVector");
...
void ObsVector<OBS>::ones() {
  ...
  utiljedi::Timer timer(classname(), "ones");
...
void ObsVector<OBS>::invert() {
  ...
  utiljedi::Timer timer(classname(), "invert");
...
double ObsVector<OBS>::dot_product_with(const ObsVector & other) const {
  ...
  utiljedi::Timer timer(classname(), "dot_product");
...
void ObsVector<OBS>::mask(const ObsVector & mask) {
  ...
  utiljedi::Timer timer(classname(), "mask(ObsVector)");
...
Eigen::VectorXd  ObsVector<OBS>::packEigen(const ObsVector & mask) const {
  ...
  utiljedi::Timer timer(classname(), "packEigen");
...
size_t ObsVector<OBS>::packEigenSize(const ObsVector & mask) const {
  ...
  utiljedi::Timer timer(classname(), "packEigenSize");
...
#endif  // OOPSJEDI_INTERFACE_OBSVECTOR_H_
