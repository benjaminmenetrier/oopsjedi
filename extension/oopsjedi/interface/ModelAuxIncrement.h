...
#ifndef OOPSJEDI_INTERFACE_MODELAUXINCREMENT_H_
#define OOPSJEDI_INTERFACE_MODELAUXINCREMENT_H_
...
class ModelAuxIncrement : public utiljedi::Printable,
                          public utiljedi::Serializable,
                          private utiljedi::ObjectCounter<ModelAuxIncrement<MODEL> > {
 ...
 public:
  ...
  static const std::string classname() {return "oopsjedi::ModelAuxIncrement";}
...
ModelAuxControl<MODEL> & operator+=(ModelAuxControl<MODEL> & xx,
  ...
  utiljedi::Timer timer("oopsjedi::ModelAuxIncrement", "operator+=ModelAuxControl");
                                            ...
                                            const Parameters_ & parameters) : aux_()
{
  ...
  utiljedi::Timer timer(classname(), "ModelAuxIncrement");
...
#endif  // OOPSJEDI_INTERFACE_MODELAUXINCREMENT_H_
