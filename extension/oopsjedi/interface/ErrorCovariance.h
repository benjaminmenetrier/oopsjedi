...
#ifndef OOPSJEDI_INTERFACE_ERRORCOVARIANCE_H_
#define OOPSJEDI_INTERFACE_ERRORCOVARIANCE_H_
...
#include "oopsjedi/base/ModelSpaceCovarianceBase.h"
...
class ErrorCovariance : public oopsjedi::ModelSpaceCovarianceBase<MODEL>,
                        public utiljedi::Printable,
                        private utiljedi::ObjectCounter<ErrorCovariance<MODEL> >,
 ...
 public:
  ...
  static const std::string classname() {return "oopsjedi::ErrorCovariance";}
  ...
  : ModelSpaceCovarianceBase<MODEL>(resol, parameters, xb, fg), covariance_()
{
  ...
  utiljedi::Timer timer(classname(), "ErrorCovariance");
...
void ErrorCovariance<MODEL>::doRandomize(Increment_ & dx) const {
  ...
  utiljedi::Timer timer(classname(), "doRandomize");
...
void ErrorCovariance<MODEL>::doMultiply(const Increment_ & dx1, Increment_ & dx2) const {
  ...
  utiljedi::Timer timer(classname(), "doMultiply");
...
void ErrorCovariance<MODEL>::doInverseMultiply(const Increment_ & dx1, Increment_ & dx2) const {
  ...
  utiljedi::Timer timer(classname(), "doInverseMultiply");
...
#endif  // OOPSJEDI_INTERFACE_ERRORCOVARIANCE_H_
