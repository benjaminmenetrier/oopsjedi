...
#ifndef OOPSJEDI_INTERFACE_MODELAUXCOVARIANCE_H_
#define OOPSJEDI_INTERFACE_MODELAUXCOVARIANCE_H_
...
class ModelAuxCovariance : public utiljedi::Printable,
                           private boost::noncopyable,
                           private utiljedi::ObjectCounter<ModelAuxCovariance<MODEL> > {
 ...
 public:
  ...
  static const std::string classname() {return "oopsjedi::ModelAuxCovariance";}
                                              ...
                                              const Geometry_ & resol) : cov_()
{
  ...
  utiljedi::Timer timer(classname(), "ModelAuxCovariance");
...
#endif  // OOPSJEDI_INTERFACE_MODELAUXCOVARIANCE_H_
