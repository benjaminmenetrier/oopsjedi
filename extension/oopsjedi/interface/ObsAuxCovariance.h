...
#ifndef OOPSJEDI_INTERFACE_OBSAUXCOVARIANCE_H_
#define OOPSJEDI_INTERFACE_OBSAUXCOVARIANCE_H_
...
#include "oopsjedi/interface/ObsAuxPreconditioner.h"
...
class ObsAuxCovariance : public utiljedi::Printable,
                         private boost::noncopyable,
                         private utiljedi::ObjectCounter<ObsAuxCovariance<OBS> > {
 ...
 public:
  ...
  static const std::string classname() {return "oopsjedi::ObsAuxCovariance";}
                                          ...
                                          const Parameters_ & params) : cov_()
{
  ...
  utiljedi::Timer timer(classname(), "ObsAuxCovariance");
...
void ObsAuxCovariance<OBS>::linearize(const ObsAuxControl_ & xx,
  ...
  utiljedi::Timer timer(classname(), "linearize");
...
void ObsAuxCovariance<OBS>::inverseMultiply(const ObsAuxIncrement_ & dx1,
  ...
  utiljedi::Timer timer(classname(), "inverseMultiply");
...
void ObsAuxCovariance<OBS>::randomize(ObsAuxIncrement_ & dx) const {
  ...
  utiljedi::Timer timer(classname(), "randomize");
...
ObsAuxPreconditioner<OBS> ObsAuxCovariance<OBS>::preconditioner() const {
    ...
    utiljedi::Timer timer(classname(), "preconditioner");
...
#endif  // OOPSJEDI_INTERFACE_OBSAUXCOVARIANCE_H_
