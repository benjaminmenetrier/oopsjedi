...
#ifndef OOPSJEDI_INTERFACE_OBSAUXINCREMENT_H_
#define OOPSJEDI_INTERFACE_OBSAUXINCREMENT_H_
...
class ObsAuxIncrement : public utiljedi::Printable,
                        public utiljedi::Serializable,
                        private utiljedi::ObjectCounter<ObsAuxIncrement<OBS> > {
 ...
 public:
  ...
  static const std::string classname() {return "oopsjedi::ObsAuxIncrement";}
...
ObsAuxControl<OBS> & operator+=(ObsAuxControl<OBS> & xx, const ObsAuxIncrement<OBS> & dx) {
  ...
  utiljedi::Timer timer("oopsjedi::ObsAuxIncrement", "operator+=ObsAuxControl");
                                      ...
                                      const Parameters_ & params) : aux_()
{
  ...
  utiljedi::Timer timer(classname(), "ObsAuxIncrement");
...
#endif  // OOPSJEDI_INTERFACE_OBSAUXINCREMENT_H_
