...
#ifndef OOPSJEDI_BASE_INCREMENTENSEMBLE_H_
#define OOPSJEDI_BASE_INCREMENTENSEMBLE_H_
...
#include "oopsjedi/base/LocalIncrement.h"
#include "oopsjedi/base/State.h"
#include "oopsjedi/base/StateEnsemble.h"
#include "oopsjedi/base/Variables.h"
#include "oopsjedi/util/ConfigFunctions.h"
#include "oopsjedi/util/DateTime.h"
#include "oopsjedi/util/Logger.h"
#include "oopsjedi/util/parameters/OptionalParameter.h"
#include "oopsjedi/util/parameters/Parameter.h"
#include "oopsjedi/util/parameters/Parameters.h"
#include "oopsjedi/util/parameters/ParametersOrConfiguration.h"
#include "oopsjedi/util/parameters/RequiredParameter.h"
...
class IncrementEnsembleParameters : public Parameters {
 ...
 public:
  RequiredParameter<utiljedi::DateTime> date{"date", "increment date", this};
  ...
  void deserialize(utiljedi::CompositePath &path, const eckit::Configuration &config) override;
...
template <typename MODEL>
void IncrementEnsembleParameters<MODEL>::deserialize(utiljedi::CompositePath &path,
  ...
  IncrementEnsembleParameters<MODEL>::getIncrementParameters(const size_t & ie) const
{
  ...
  if (increments.value() != boost::none) {
    ...
    utiljedi::seekAndReplace(memberConf, increments_template.value()->pattern,
...
template<typename MODEL> class IncrementEnsemble {
 ...
 public:
  ...
  IncrementEnsemble(const Geometry_ & resol, const Variables & vars,
                    const utiljedi::DateTime &, const int rank);
  IncrementEnsemble(const IncrementEnsembleFromStatesParameters_ &,
                    const Geometry_ &, const Variables &, const utiljedi::DateTime &);
  ...
  : ensemblePerturbs_()
{
  ...
  State_ zerov(resol, params.states.getStateParameters(0));
  zerov.zero();
  ...
  : ensemblePerturbs_()
{
  ...
  utiljedi::DateTime time = params.date;
...
#endif  // OOPSJEDI_BASE_INCREMENTENSEMBLE_H_
